    ...
    return (
      <div style={{ display: "flex", width: "100%", height: "100%", fontFamily: "Georgia, serif", background: "#fff" }}>
        <div style={{ width: "34%", background: "#1e293b", padding: "28px 16px", color: "#fff", flexShrink: 0 }}>
          <div style={{ width: 60, height: 60, borderRadius: "50%", background: accent, margin: "0 auto 12px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, fontWeight: 800, color: "#fff" }}>
            {p.name.split(" ").map((n) => n[0]).join("")}
          </div>
          <div style={{ fontSize: 16, fontWeight: 800, textAlign: "center", color: "#fff", lineHeight: 1.2, marginBottom: 4 }}>{p.name}</div>
          <div style={{ fontSize: 10, color: accent, textAlign: "center", textTransform: "uppercase", letterSpacing: 1, fontWeight: 700, marginBottom: 18 }}>{p.title}</div>
          ...
          <div style={{ fontSize: 10, color: accent, fontWeight: 800, textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>Skills</div>
          {p.skills.map((s, i) => (
            <div key={i} style={{ marginBottom: 8 }}>
              <div style={{ fontSize: 9, color: "#cbd5e1", marginBottom: 3 }}>{s}</div>
              <div style={{ height: 4, background: "#334155", borderRadius: 2 }}>
                <div style={{ height: "100%", width: `${88 - (i * 9) % 38}%`, background: accent, borderRadius: 2 }} />
              </div>
            </div>
          ))}
          <div style={{ height: 1, background: "#334155", margin: "12px 0" }} />
          <div style={{ fontSize: 10, color: accent, fontWeight: 800, textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>Education</div>
          {p.education.map((e, i) => (
            <div key={i} style={{ marginBottom: 10 }}>
              <div style={{ fontSize: 9, fontWeight: 700, color: "#e2e8f0", lineHeight: 1.3 }}>{e.degree}</div>
              <div style={{ fontSize: 8, color: "#94a3b8" }}>{e.school} · {e.year}</div>
            </div>
          ))}
        </div>
        <div style={{ flex: 1, padding: "28px 20px", background: "#fff" }}>
          <div style={{ fontSize: 11, fontWeight: 800, color: "#0f172a", textTransform: "uppercase", letterSpacing: 1.5, borderBottom: `2px solid ${accent}`, paddingBottom: 6, marginBottom: 10 }}>Profile</div>
          <div style={{ fontSize: 10, color: "#475569", lineHeight: 1.7, marginBottom: 16 }}>{p.summary}</div>
          <div style={{ fontSize: 11, fontWeight: 800, color: "#0f172a", textTransform: "uppercase", letterSpacing: 1.5, borderBottom: `2px solid ${accent}`, paddingBottom: 6, marginBottom: 10 }}>Work Experience</div>
          {p.experience.map((exp, i) => (
            <div key={i} style={{ marginBottom: 13 }}>
              ...
              {exp.bullets.map((b, j) => (
                <div key={j} style={{ fontSize: 9, color: "#475569", lineHeight: 1.6, paddingLeft: 12, position: "relative" }}>
                  <span style={{ position: "absolute", left: 3 }}>•</span>{b}
                </div>
              ))}
            </div>
          ))}
    ...
    return (
      <div style={{ width: "100%", height: "100%", fontFamily: "Georgia, serif", background: "#fff" }}>
        <div style={{ background: accent, padding: "22px 24px 16px" }}>
          <div style={{ fontSize: 30, fontWeight: 900, color: "#fff", letterSpacing: -0.5, lineHeight: 1 }}>{p.name}</div>
          <div style={{ fontSize: 12, color: "rgba(255,255,255,0.88)", textTransform: "uppercase", letterSpacing: 2, fontWeight: 600, marginTop: 5 }}>{p.title}</div>
          <div style={{ fontSize: 9, color: "rgba(255,255,255,0.65)", marginTop: 6 }}>{p.email} · {p.phone} · {p.location}</div>
        </div>
        <div style={{ display: "flex" }}>
          <div style={{ flex: 1, padding: "18px 18px" }}>
            <div style={{ fontSize: 11, fontWeight: 800, color: accent, textTransform: "uppercase", letterSpacing: 1.5, borderBottom: `2px solid ${accent}`, paddingBottom: 5, marginBottom: 10 }}>Profile</div>
            <div style={{ fontSize: 10, color: "#475569", lineHeight: 1.7, marginBottom: 14 }}>{p.summary}</div>
            <div style={{ fontSize: 11, fontWeight: 800, color: accent, textTransform: "uppercase", letterSpacing: 1.5, borderBottom: `2px solid ${accent}`, paddingBottom: 5, marginBottom: 10 }}>Work Experience</div>
            {p.experience.map((exp, i) => (
          ...
          <div style={{ width: "32%", background: "#f8fafc", padding: "18px 14px", borderLeft: `3px solid ${accent}` }}>
            <div style={{ fontSize: 11, fontWeight: 800, color: accent, textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>Skills</div>
            {p.skills.map((s, i) => (
              <div key={i} style={{ fontSize: 9, color: "#334155", lineHeight: 1.9, display: "flex", alignItems: "center", gap: 5 }}>
                <span style={{ width: 5, height: 5, borderRadius: "50%", background: accent, display: "inline-block", flexShrink: 0 }} />{s}
              </div>
            ))}
            <div style={{ height: 1, background: "#e2e8f0", margin: "12px 0" }} />
            <div style={{ fontSize: 11, fontWeight: 800, color: accent, textTransform: "uppercase", letterSpacing: 1, marginBottom: 10 }}>Education</div>
            {p.education.map((e, i) => (
              <div key={i} style={{ marginBottom: 10 }}>
    ...
    return (
      <div style={{ width: "100%", height: "100%", fontFamily: "Georgia, serif", background: "#fff" }}>
        <div style={{ background: "#1e293b", padding: "18px 22px", display: "flex", alignItems: "center", gap: 16 }}>
          <div style={{ width: 68, height: 68, borderRadius: "50%", background: accent, flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, fontWeight: 800, color: "#fff", border: "3px solid rgba(255,255,255,0.2)" }}>
            {p.name.split(" ").map((n) => n[0]).join("")}
          </div>
          <div>
            <div style={{ fontSize: 26, fontWeight: 900, color: "#fff", letterSpacing: -0.3, lineHeight: 1 }}>{p.name}</div>
            <div style={{ fontSize: 11, color: accent, textTransform: "uppercase", letterSpacing: 1.5, fontWeight: 700, marginTop: 5 }}>{p.title}</div>
            <div style={{ fontSize: 9, color: "rgba(255,255,255,0.55)", marginTop: 5 }}>{p.email} · {p.phone} · {p.location}</div>
          </div>
        </div>
        <div style={{ height: 4, background: `linear-gradient(90deg, ${accent}, ${accent}60)` }} />
        <div style={{ padding: "16px 22px" }}>
          <div style={{ fontSize: 11, fontWeight: 800, color: "#0f172a", textTransform: "uppercase", letterSpacing: 1.5, borderBottom: `2px solid ${accent}`, paddingBottom: 5, marginBottom: 10 }}>Profile</div>
          <div style={{ fontSize: 10, color: "#475569", lineHeight: 1.7, marginBottom: 14 }}>{p.summary}</div>
          <div style={{ fontSize: 11, fontWeight: 800, color: "#0f172a", textTransform: "uppercase", letterSpacing: 1.5, borderBottom: `2px solid ${accent}`, paddingBottom: 5, marginBottom: 10 }}>Work Experience</div>
          {p.experience.map((exp, i) => (
            <div key={i} style={{ marginBottom: 12 }}>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ fontSize: 11, fontWeight: 700, color: "#0f172a" }}>{exp.role}</span>
          ...
          <div style={{ fontSize: 11, fontWeight: 800, color: "#0f172a", textTransform: "uppercase", letterSpacing: 1.5, borderBottom: `2px solid ${accent}`, paddingBottom: 5, marginBottom: 10, marginTop: 14 }}>Education</div>
          {p.education.map((e, i) => (
            <div key={i} style={{ fontSize: 10, color: "#334155", marginBottom: 5 }}>
              <span style={{ fontWeight: 700 }}>{e.degree}</span> — {e.school} · {e.year}
            </div>
          ))}
          <div style={{ fontSize: 11, fontWeight: 800, color: "#0f172a", textTransform: "uppercase", letterSpacing: 1.5, borderBottom: `2px solid ${accent}`, paddingBottom: 5, marginBottom: 10, marginTop: 14 }}>Skills</div>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
            {p.skills.map((s, i) => (
              <span key={i} style={{ fontSize: 9, background: `${accent}18`, color: accent, padding: "3px 8px", borderRadius: 3, border: `1px solid ${accent}40`, fontWeight: 600 }}>{s}</span>
            ))}
          </div>
        </div>
      </div>
  ...
  return (
    <div style={{ width: "100%", height: "100%", fontFamily: "Georgia, serif", background: "#fff" }}>
      <div style={{
        ...
        <div style={{ fontSize: isExecutive ? 26 : 24, fontWeight: 900, color: headerText, letterSpacing: isExecutive ? 3 : -0.3, lineHeight: 1 }}>
          {isExecutive ? p.name.toUpperCase() : p.name}
        </div>
        <div style={{ fontSize: 12, color: accentOnHeader, textTransform: "uppercase", letterSpacing: isExecutive ? 3 : 1.5, fontWeight: 600, marginTop: 5 }}>{p.title}</div>
        <div style={{ fontSize: 9, color: headerBg === "#fff" ? "#64748b" : "rgba(255,255,255,0.6)", marginTop: 6 }}>{p.email} · {p.phone} · {p.location}</div>
      </div>
      {isExecutive && <div style={{ height: 4, background: "linear-gradient(90deg,#c9a84c,#f0d080,#c9a84c)" }} />}

      <div style={{ padding: "16px 22px" }}>
        <div style={{ fontSize: 11, fontWeight: 800, color: sectionLabelColor, textTransform: "uppercase", letterSpacing: 1.5, borderBottom: `2px solid ${bodyAccent}`, paddingBottom: 5, marginBottom: 10 }}>
        ...
        {p.experience.map((exp, i) => (
          <div key={i} style={{ marginBottom: 12 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: "#0f172a", flex: 1, lineHeight: 1.2 }}>{exp.role}</span>
              <span style={{ fontSize: 9, color: bodyAccent, fontWeight: 600, flexShrink: 0, marginLeft: 8 }}>{exp.dates}</span>
            </div>
        ...
        <div style={{ fontSize: 11, fontWeight: 800, color: sectionLabelColor, textTransform: "uppercase", letterSpacing: 1.5, borderBottom: `2px solid ${bodyAccent}`, paddingBottom: 5, marginBottom: 10, marginTop: 14 }}>
          Education
        </div>
        {p.education.map((e, i) => (
          <div key={i} style={{ fontSize: 10, color: "#334155", marginBottom: 5 }}>
