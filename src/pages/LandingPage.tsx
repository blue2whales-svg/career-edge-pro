  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <a
        ...
        className="fixed bottom-20 left-4 sm:bottom-6 sm:left-auto sm:right-6 z-50 w-14 h-14 rounded-full bg-emerald-500 flex items-center justify-center shadow-lg hover:bg-emerald-600 transition-colors"
