    ...
    <div className="flex flex-col items-center gap-2">
      <div className="relative w-[120px] h-[120px]">
        <svg width="120" height="120" viewBox="0 0 120 120">
          ...
          <circle cx="60" cy="60" r={radius} fill="none" stroke={config.text} strokeWidth="8" strokeLinecap="round"
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 h-2 rounded-full" style={{ background: "rgba(255,255,255,0.08)" }}>
        <div className="h-full rounded-full" style={{ width: `${width}%`, background: color, transition: "width 0.8s cubic-bezier(0.4,0,0.2,1)" }} />
      </div>
            ...
            {isLow ? (
              ...
              <div className="rounded-xl border border-green-500/20 bg-green-500/5 p-5 space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <Button onClick={() => { onClose(); setPaymentOpen(true); }} className="flex-1 font-semibold text-sm h-10 bg-gradient-brand border-0">
