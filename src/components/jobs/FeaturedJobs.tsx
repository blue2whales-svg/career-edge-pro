...
import { MapPin, DollarSign, Clock, Building2, ArrowRight, Flame, Ship, Sparkles, Globe2 } from "lucide-react";
      ...
      <div className="container max-w-5xl mx-auto">
        ...
        {isLoading ? (
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="rounded-xl border-2 border-border bg-card p-5">
