      ...
      <div className="container relative mx-auto px-4">
        ...
        <div className="mx-auto mt-12 flex max-w-5xl flex-col gap-8">
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-primary/20 bg-card/70 p-4 shadow-2xl backdrop-blur md:p-6">
            ...
            <div className="rounded-[24px] border border-primary/20 bg-white shadow-xl">
              <div className="mx-auto max-w-4xl p-5 md:p-8">
                <div className="border-b border-slate-200 pb-5">
                  <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                    <div>
                      <h3 className="text-2xl font-bold text-slate-900 md:text-3xl">John Kamau</h3>
                      <p className="mt-2 text-sm font-semibold uppercase tracking-[0.14em] text-primary">
                    ...
                    <div className="rounded-2xl border border-primary/20 bg-primary/5 px-4 py-3">
                      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-primary">ATS Score Feel</p>
                      <p className="mt-1 text-lg font-bold text-slate-900">Premium Match</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 grid gap-6 md:grid-cols-[1.3fr_0.7fr]">
                  <div className="space-y-5">
                    <div>
                      <h4 className="text-xs font-bold uppercase tracking-[0.18em] text-slate-800">
                        Professional Summary
                      </h4>
                      <p className="mt-2 text-sm leading-7 text-slate-700">
                        Results-driven sales professional with 4+ years driving B2B revenue across East African markets.
                        Proven success in exceeding targets by 35%+, expanding client portfolios, and building long-term
                        revenue pipelines worth over KES 120M annually.
                      </p>
                    </div>

                    <div className="border-t border-slate-200 pt-4">
                      <h4 className="text-xs font-bold uppercase tracking-[0.18em] text-slate-800">Experience</h4>

                      <div className="mt-3">
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            <p className="text-sm font-semibold text-slate-900">Senior Sales Executive</p>
                        ...
                        <ul className="mt-3 list-disc pl-5 text-sm leading-7 text-slate-700">
                          ...
                          <li>Mentored 6 sales reps across 3 countries, lifting team performance</li>
                          <li>
                            Improved client retention through stronger relationship management and follow-up systems
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="mt-5">
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            <p className="text-sm font-semibold text-slate-900">Sales Intern</p>
                    ...
                    <div className="border-t border-slate-200 pt-4">
                      ...
                      <div className="mt-2 flex items-start justify-between gap-3">
                        <div>
                          <p className="text-sm font-semibold text-slate-900">B.Com Finance — First Class Honours</p>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
                      ...
                      <ul className="mt-3 space-y-2 text-sm text-slate-700">
                        ...
                        <li>✓ Clear premium layout</li>
                        <li>✓ Achievement-driven experience</li>
                        <li>✓ Easy recruiter scan flow</li>
                        <li>✓ Better professional positioning</li>
