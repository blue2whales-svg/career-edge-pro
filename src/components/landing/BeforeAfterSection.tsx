  ...
  <div className="container relative mx-auto px-4">
    <div className="mx-auto max-w-4xl text-center">
      ...
      <h2 className="mt-5 text-3xl font-bold leading-tight text-foreground md:text-5xl">
        From <span className="text-red-400">overlooked</span> to <span className="text-primary">interview-ready</span>
      </h2>

      <p className="mx-auto mt-4 max-w-2xl text-sm text-muted-foreground md:text-base">
        CV Edge transforms weak, ordinary CVs into premium documents built for serious employers in Kenya and abroad.
      </p>

      <div className="mt-5 inline-flex items-center rounded-full border border-border bg-card/60 px-4 py-2 text-xs md:text-sm text-foreground shadow-glow-sm">
    ...
    <div className="mt-12 grid gap-6 lg:grid-cols-2">
      ...
      <div className="relative rounded-3xl border border-red-500/20 bg-card/70 p-4 shadow-2xl backdrop-blur md:p-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-red-500 text-white shadow-lg">✕</div>
        </div>
          ...
          <div className="grid min-h-[520px] md:min-h-[560px] md:grid-cols-[140px_1fr]">
            ...
            <div className="px-5 py-6 text-left text-[11px] text-slate-800 md:px-6 md:text-xs">
              <div className="border-b pb-3">
                ...
                <p className="mt-2 text-slate-500">Nairobi, Kenya • johnkamau@gmail.com • linkedin.com/in/johnkamau</p>
              </div>
              ...
              <div className="mt-4 border-b pb-4">
                ...
                <div className="mt-4">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span className="text-primary font-semibold">2019 – 2020</span>
                  </div>
