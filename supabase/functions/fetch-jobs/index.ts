...
async function fetchJooble(apiKey: string): Promise<any[]> {
  const queries = [
    ...
    { keywords: "remote software developer", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote customer support", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote virtual assistant", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote data entry", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote content writer", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote marketing manager", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote project manager", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote designer", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote accountant", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote teacher tutor online", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote sales representative", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote recruiter HR", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "remote translator transcription", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "fully remote jobs worldwide", location: "", market: "Remote", tag: "🌍 Remote" },
    { keywords: "work from home Kenya remote", location: "Kenya", market: "Remote", tag: "🌍 Remote" },
